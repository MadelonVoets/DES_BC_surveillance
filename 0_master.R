##-----------------------------------------------------------------------------------------##
##                                                                                         ##
##            Developing a simulation model to support implementation of                   ##
##             artificial intelligence in breast cancer surveillance                       ##
##                                                                                         ##
##                                                                                         ##
##                                                                                         ##
##-----------------------------------------------------------------------------------------##
...
# 1. Init             defines the environment for the analysis
