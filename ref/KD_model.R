#https://r-hta.org/events/workshop/2021/degeling.pdf
...
library(simmer)           # implementing and running discrete event simulations
library(simmer.plot)      # plotting discrete event simulation objects and outputs
library(flexsurv)         # Gompertz distribution functions
library(data.table)       # efficient wrangling of simulation output
